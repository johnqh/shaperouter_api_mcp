 ...
 *
 * An entity API key (`shrouteent_...`) authenticates a caller as the *entity*
 ...
 *
 * Do not confuse this with the *personal* key (`shroute_...`, see apikeys.ts),
...
const entitySlugArg = z
  .string()
  .optional()
  .describe("Entity slug that owns the key. Defaults to SHAPEROUTER_ENTITY_SLUG.");
